...
<body class="font-sans antialiased dark:bg-blend-hard-light dark:text-white/50">
            ...
            <div class="md:flex md:justify-between">
                <div class="mb-12 md:mb-0 flex justify-center ">
                    <a href="/" class="flex items-center">
                        <img loading="lazy" src="storage/images/logos/LOGOtext.png" class="mr-3 h-24"
                             alt="Logo" />
                    </a>
                </div>
                ...
                <div class="grid grid-cols-3 gap-8 ">
                    <div>
                        ...
                        <ul class=" text-gray-400">
                            <li class="mb-4">
                                <a href="https://laravel.com/" target='_blank'="hover:underline">Laravel 11</a>
                            </li>
                            <li>
